...
export const api = {
  ...
  createDailyLogFull: (payload) => request("/daily-logs/full", { method: "POST", body: JSON.stringify(payload) }),
  getDailyLogFullByDate: (logDate) => request(`/daily-logs/full/by-date/${logDate}`),
